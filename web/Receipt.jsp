    ...
    <body oncontextmenu="return false">
        ...
        <%
            ...
            if (Lb != null && Lb.getStatus()) {
                ...
                String sky = "";
                String dsbld = "";
                /*artcls = vls.Artcls();int kusr = Integer.parseInt(kary[9]);*/
                logo = cssn.logo();
                ...
                String clt2 = clt;
                try{
                    String ctt = clt.split(" ")[0];
                    clt = ctt;
                }catch(Exception e){
                
                }
                try{
                    String ctt = clt2.split(" ")[1];
                    name = ctt;
                }catch(Exception e){
                ...
                try {
                    ...
                    String qry = "select CONCAT(CAST(user_datetime AS DATE),CONCAT(' ',CAST(user_datetime AS TIME))) as user_datetime "
                            + " from sales where client_nr = " + clt;
                ...
                if (y > 1) {
                    ...
                    try {
                        ...
                        String reportFileName = "receipt_sale.jrxml";
                        ...
                        prts.put("pgtitle", lang.lng(current_lang, "paymentconfirmation"));
                        prts.put("pgnotice", lang.lng(current_lang, "doesnotserveasareceipt"));
                        prts.put("pgarticle", lang.lng(current_lang, "article"));
                        prts.put("payment", lang.lng(current_lang, "amountpaid"));
                        ...
                        if (bytes != null && bytes.length > 0) {
                            ...
                            response.addHeader("Content-disposition", "filename=Receipt" + Lb.getUser() + clt + ".pdf");
        ...
        %>
        <div style="color: red; margin-top: 30%;"><%=lang.lng(current_lang, "this_sale_with_the_number")%> <strong style="color: blue;"><%=clt%></strong> <%=lang.lng(current_lang, "not_yet_registered")%>!</div>
        <%
            }
        } else {
        %>
